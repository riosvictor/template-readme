...
<h1 align="center">
    <img alt="banner" title="#banner" src="./docs/banner.jpeg" />
</h1>
...
- [x] Funcionalidade B
  - [x] Funcionalidade B.1
  - [x] Funcionalidade B.2
...
Alguns screenshots do projeto para visualização inicial
...
Breve descrição sobre as partes do projeto, e como se comunicam, em texto corrido.
...
#### [](https://github.com/tgmarinho/Ecoleta#server-nodejs--typescript)**Backend**
